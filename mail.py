...
age=20
gender="Male"
mail="bharath.sudarsanam04@gmail.com"
status="Yes"
length="10mm"
width="5mm"
area="50mm^2"
location="Top left"
Id="1234"
decription="The tumor is relatively small and localized. It may be contained within a single area of the brain and not extensively affecting surrounding tissues."
wtd="Conduct detailed imaging studies like MRI or CT scans to confirm the exact location and extent of the tumor."
wtc="Neurosurgeon: For surgical evaluation and possible removal of the tumor."
html_template = """
...
<p style="line-height: 140%; word-wrap: break-word; font-family: Epilogue; font-size: 15px; font-weight: 200;"><strong>Tumor length(in mm): {length}</strong></p>
<p style="line-height: 140%; word-wrap: break-word; font-family: Epilogue; font-size: 15px; font-weight: 200;"><strong>Tumor breadth(in mm): {breadth}</strong></p>
<p style="line-height: 140%; word-wrap: break-word; font-family: Epilogue; font-size: 15px; font-weight: 200;"><strong>Tumor Area(in mm square): {area}</strong></p>
...
# Example usage
send_email(to_email="bharath.sudarsanam04@gmail.com", subject="Automated Test Email", html_content=html_content)
